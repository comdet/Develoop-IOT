...
module.exports = function(Blockly) {
  ...
  Blockly.JavaScript["kivvi_rgb_begin"] = function(block) {
  ...
  Blockly.JavaScript["kivvi_rgb_clear"] = function(block) {
    var code =
      `
  ...
  Blockly.JavaScript["kivvi_rgb_show"] = function(block) {
    var code =
      `
  pixels.show();
  `;
  ...
  Blockly.JavaScript["kivvi_rgb_setBrightness"] = function(block) {
  ...
  Blockly.JavaScript["kivvi_rgb_setPixelColor"] = function(block) {
  ...
  Blockly.JavaScript["kivvi_rgb_colorWipe"] = function(block) {
  ...
  Blockly.JavaScript["kivvi_rgb_theaterChase"] = function(block) {
    var value_time = valueToCode(block, "TIME", ORDER_ATOMIC);
    var value_color = block.getFieldValue("COLOR");
    var color = hexToRgbA(value_color);
    let [value_r, value_g, value_b] = color;
  ...
  Blockly.JavaScript["kivvi_rgb_rainbow_begin"] = function(block) {
    var code =
      `
  ...
  Blockly.JavaScript["kivvi_rgb_rainbow"] = function(block) {
    var value_time = valueToCode(block, "TIME", ORDER_ATOMIC);
    var code =
      `
  uint16_t i, j;
  ...
  Blockly.JavaScript["kivvi_rgb_rainbowCycle"] = function(block) {
    var value_time = valueToCode(block, "TIME", ORDER_ATOMIC);
    var code =
      `
  uint16_t k, m;
